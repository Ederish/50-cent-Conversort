var flags = ["img/AR.jpg", "img/CL.png","img/CO.png","img/CU.png","img/DO.png","img/MX.png","img/UY.png","img/VE.png"]
var latamFlag = document.getElementById("latam-flag");
var apiKey ="7b783d9b754f45088795c0ef730f6e4f";

async function fetchCurrency() {
      const api = `https://api.currencyfreaks.com/v2.0/rates/latest?apikey=${apiKey}&format=json&symbols=ARS,CLP,COP,CUC,DOP,MXN,UYU,VES`;
    ...
    async function updateCurrency() {
      ...
      switch (countries) {
        ...
        case "UY":
          ...
          break;
          case "VE":
          coins.innerHTML = Math.floor(coinsApi["VES"] / 2) + " Bolivares";
          latamFlag.src = flags[7];
          break;
        default:
